...
const _e6c97440 = () => import('../client/pages/smarthardware/doormanage/equipmentmanage/index.vue' /* webpackChunkName: "pages/smarthardware/doormanage/equipmentmanage/index" */).then(m => m.default || m)
...
const _339ef56e = () => import('../client/pages/smarthardware/doormanage/equipmentmanage/searchForm.vue' /* webpackChunkName: "pages/smarthardware/doormanage/equipmentmanage/searchForm" */).then(m => m.default || m)
...
export function createRouter () {
  return new Router({
    ...
    routes: [
		...
		{
			path: "/smarthardware/doormanage/equipmentmanage",
			component: _e6c97440,
			name: "smarthardware-doormanage-equipmentmanage"
		},
		{
		...
		{
			path: "/smarthardware/doormanage/equipmentmanage/searchForm",
			component: _339ef56e,
			name: "smarthardware-doormanage-equipmentmanage-searchForm"
		},
		{
