...
module.exports = {
     //项目管理－新建任务
     'project-add-task': {
      url: '/api/krspace-pm-web/pm/task/add',
      method: 'post'
    },
    //任务名称唯一性校验
    'project-name-check': {
      url: '/api/krspace-pm-web/pm/task/unique',
      method: 'get'
    },
    //项目管理－编辑任务
    'project-edit-task': {
      url: '/api/krspace-pm-web/pm/task/edit',
      method: 'post'
    },
    //项目管理－删除任务
    'project-delete-task': {
      url: '/api/krspace-pm-web/pm/task/delete',
      method: 'delete'
    },
    //项目管理－查询任务
    'project-get-task': {
      url: '/api/krspace-pm-web/pm/task/detail',
      method: 'get'
    },
    //项目管理－查询任务列表
    'project-list-task': {
      url: '/api/krspace-pm-web/pm/task/list',
      method: 'get'
    },
    //项目管理－项目进度列表
    ...
    //项目详情星星
    'project-detail-star': {
      url: '/api/krspace-pm-web/pm/task/focus',
      method: 'post'
    },
    //根据项目id查询甘特图显示任务项
    'project-id-search': {
      url: '/api/krspace-pm-web/pm/task/tree',
      method: 'get'
    },
    //项目管理-档案管理-档案树部
