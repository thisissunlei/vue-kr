            ...
            <Form ref="formItemInvestment"
                ...
                <div style="padding: 30px 10px 10px 20px;background:#fff;margin-top:20px;">
                    <div style="white-space: nowrap;">
                        <span class="attract-font"
                            style="padding-top:7px;margin-right:13px;">楼<span style="display:inline-block;width:25px;"></span>层</span>
                        ...
                        <Form-item label="物理空间"
                            class='daily-form'>
                            <Select v-model="formItem.binding"
                                style="width: 200px;;margin-left:10px;"
                                clearable>
                                <Option v-for="item in bindingtList"
                                    :value="item.value"
                                    :key="item.value">{{ item.label }}</Option>
                            </Select>
                        </Form-item>
                    ...
                    <div style="white-space: nowrap; margin-right:0;">
                        <div class="daily-form">
                            ...
                            <div class="daily-form">
                                <span class="attract-font"
                                    style="padding-top:7px;">工位数量</span>
                                <Form-item class="priceForm"
                                    prop="stationsMin">
                                    <i-input v-model="formItem.stationsMin"
                                        style="width: 90px"
                                ...
                                <Form-item class="priceForm"
                                    prop="stationsMax">
                                    <i-input v-model="formItem.stationsMax"
                                        style="width: 90px"
                                        @keyup.enter.native="onKeyEnter($event)" />
                                </Form-item>
                            </div>
                            <Form-item label="商品属性"
                                ...
                                <Select v-model="formItem.suiteType"
                                    ...
                                    clearable>
                                    <Option v-for="item in suiteType"
                                        :value="item.value"
                                        :key="item.value">{{ item.label }}</Option>
                                </Select>
                            </Form-item>
                    ...
                    <div style="white-space: nowrap;">
                        ...
                        <span class="attract-font"
                            style="padding-top:7px;">商品定价</span>
                        <Form-item class="priceForm"
                            prop="priceMin">
                            <i-input v-model="formItem.priceMin"
                                style="width: 90px"
                                @keyup.enter.native="onKeyEnter($event)" />
                        </Form-item>
                        <span class="attract-line"
                            style="margin:0 3px 0 4px">至</span>
                        <Form-item class="priceForm"
                            prop="priceMax">
                            <i-input v-model="formItem.priceMax"
                                style="width: 90px"
                                @keyup.enter.native="onKeyEnter($event)" />
                        </Form-item>
                        ...
                        <div class='daily-form'>
                            <span class="attract-font"
                                style="padding-top:7px;margin-right:13px;margin-left:20px;">面<span style="display:inline-block;width:25px;"></span>积</span>
                            <Form-item class="priceForm"
                                prop="areaMin">
                                <i-input v-model="formItem.areaMin"
                                    style="width: 90px"
                                    @keyup.enter.native="onKeyEnter($event)" />
                            </Form-item>
                            <span class="attract-line">至</span>
                            <Form-item class="priceForm"
                                prop="areaMax">
                                <i-input v-model="formItem.areaMax"
                                    style="width: 90px"
                                    @keyup.enter.native="onKeyEnter($event)" />
                            </Form-item>
                        </div>

                        <Form-item label="平面图配置"
                            class='daily-form'>
                            <Select v-model="formItem.goodsLocation"
                                placeholder="请输入商品类型"
                                style="width: 200px"
                                clearable>
                                <Option v-for="item in graphList"
                                    :value="item.value"
                                    :key="item.value">{{ item.label }}</Option>
                            </Select>
                        </Form-item>
                        ...
                        <Button type="primary"
                            @click="searchClick"
                            style="margin-left:30px;">搜索</Button>
                    </div>
                </div>
            </Form>
        </div>
