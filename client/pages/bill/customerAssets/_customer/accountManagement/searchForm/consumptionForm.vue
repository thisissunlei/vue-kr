        ...
        <div class="community-header">
            <Form ref="formItemInvestment" :model="formItem" :rules="ruleInvestment" label-position="left">
                ...
                <div style="white-space: nowrap;">
                       ...
                       <Form-item v-if="type=='consumptionDetail'" label="费用类型" class='daily-form' prop="customerName">
                            <Select 
                        ...
                        <Form-item v-if="type=='balanceDetail'" label="相关凭证"  class='daily-form' prop="customerName">
                            <i-input 
                        ...
                        <Button type="ghost" style="vertical-align: top;border:solid 1px #499df1;color:#499df1;box-shadow: 0 1px 6px rgba(0, 0, 0, 0.2), 0 1px 4px rgba(0, 0, 0, 0.2);margin-left: 84px;" @click="clearClick">清除</Button>
                </div>

                <!-- 第二行-->
                <div style="white-space: nowrap;">

                    <Form-item v-if="type=='consumptionDetail'" label="相关凭证"  class='daily-form' prop="customerName">
                            <i-input 
                                v-model="formItem.customerName" 
                                placeholder="请输入相关凭证"
                                style="width: 200px"
                    ...
                    <Form-item v-if="type=='balanceDetail'" label="操作人员"  class='daily-form' prop="customerName">
                            <i-input 
                                v-model="formItem.customerName" 
                                placeholder="请输入操作人员"
                                style="width: 200px"
                    ...
                    <div class="daily-form" v-if="type=='balanceDetail'" style="margin-right:22px;">
                        <Form-item label="操作日期"  class="priceForm" prop="startDate">
                            <DatePicker 
                    ...
                    <div class="daily-form" v-if="type=='consumptionDetail'" style="margin-right:22px;">
                        <Form-item label="消费时间"  class="priceForm" prop="startDate">
                            <DatePicker 
                                v-model="formItem.startDate" 
                                placeholder="开始日期"
                                style="width: 130px"
