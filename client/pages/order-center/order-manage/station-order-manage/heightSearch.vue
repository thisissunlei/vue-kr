 <template>
  <Form ref="formItem" :model="formItem" label-position="top">
    <Form-item label="订单编号" class="bill-search-class">
      <i-input v-model="formItem.orderNum" placeholder="请输入订单编号" style="width: 252px"/>
    </Form-item>
    <Form-item label="客户名称" class="bill-search-class">
      <i-input v-model="formItem.customerName" placeholder="请输入客户名称" style="width: 252px"/>
    </Form-item>
    ...
    <Form-item label="订单类型" class="bill-search-class" v-show="type">
      <Select v-model="formItem.orderType" placeholder="请输入订单类型" style="width: 252px" clearable>
        <Option v-for="item in typeList" :value="item.value" :key="item.value">{{ item.label }}</Option>
      </Select>
    </Form-item>
    <Form-item label="订单状态" class="bill-search-class">
      <Select v-model="formItem.orderStatus" placeholder="请输入订单状态" style="width: 252px" clearable>
